...
for i in range(len(produtos)):
    ...
    print(f"produto: ", produto, "custo s/ imposto: ", round(custo,2), "custo c/ imposto: ", round(precocusto,2), "preço de venda: ", round(precovenda,2), "preço de venda com frete: ", round(precovendacomfrete,2))